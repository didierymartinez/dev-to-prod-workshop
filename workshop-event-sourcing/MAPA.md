...
**Estado: TALLER COMPLETO — 34 secciones (las 33 de la secuencia de abajo + [Serverless (Azure Functions)](secciones/serverless-azure-functions.md), intercalada tras [Transportes (RabbitMQ y ASB)](secciones/transportes-rabbitmq-asb.md)).** Bloques A convergencia · B revelar Critter Stack · C EDA · D CQRS · E multi-tenancy · F testing/idioma/NuGet · G capstone. Cada sección verificada por Bash y validada con los agentes (coherencia/técnico/principiante; build-along donde aplica); el código de framework **compila contra paquetes reales** (Marten 9.9 en [Revelar Marten](secciones/revelar-marten.md), WolverineFx 6.12 en [Revelar Wolverine](secciones/revelar-wolverine.md) y [Transportes (RabbitMQ y ASB)](secciones/transportes-rabbitmq-asb.md), proyección Marten 9 en [CQRS y proyecciones](secciones/cqrs-proyecciones.md), test xUnit verde en [Given-When-Then](secciones/given-when-then.md)) y se **verificó e2e con Docker** (Postgres + RabbitMQ) que [Revelar Marten](secciones/revelar-marten.md)/[Revelar Wolverine](secciones/revelar-wolverine.md)/[Transportes (RabbitMQ y ASB)](secciones/transportes-rabbitmq-asb.md) corren contra infra real. Cada sección ancla 1:1 a `Cosmos.BuildingBlocks` (línea 🔗 con el tipo real al que converge). 0 errores de estructura.

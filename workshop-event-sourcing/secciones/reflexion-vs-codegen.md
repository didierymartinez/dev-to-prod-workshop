...
Tu mini-contenedor de [Inyección de Dependencias](inyeccion-de-dependencias.md) resolvía dependencias con **reflexión**: `Type`, `Activator.CreateInstance`, `MethodInfo.Invoke`. Funciona, pero tiene dos costos:

...
```csharp
// 🔁 Reemplaza el InMemoryEventStore de la §05 por esta versión asíncrona
...
```csharp
// 🔁 El contrato ICommandHandler<T> de la §07, ahora async
...
[⬅️ Volver: El Command Handler](./07-el-command-handler.md)

[➡️ Siguiente: De `new` al contenedor (Inyección de Dependencias)](./09-inyeccion-de-dependencias.md)
